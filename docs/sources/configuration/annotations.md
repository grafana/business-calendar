...
{{< figure src="/media/docs/grafana/panels-visualizations/business-forms/annotations.png" class="border" alt="Options to select the annotation type and set the display limit." >}}
