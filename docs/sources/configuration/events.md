...
{{< figure src="/media/docs/grafana/panels-visualizations/business-forms/events-section.png" class="border" alt="On click parameter determines the plugin action upon a user click event." >}}
...
{{< figure src="/media/docs/grafana/panels-visualizations/business-forms/drawer-location.png" class="border" alt="Event drawer example." >}}
...
{{< figure src="/media/docs/grafana/panels-visualizations/business-forms/drawer-dissect.png" class="border" alt="A drawer dissection." >}}
...
{{< figure src="/media/docs/grafana/panels-visualizations/business-forms/tooltip-more.png" class="border" alt="The tooltip feature." >}}
...
{{< figure src="/media/docs/grafana/panels-visualizations/business-forms/multiple.png" class="border" alt="Multiple fields in the description." >}}
...
{{< figure src="/media/docs/grafana/panels-visualizations/business-forms/details-formatting.png" class="border" alt="The description formatting options." >}}
